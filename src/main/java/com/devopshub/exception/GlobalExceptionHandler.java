...
public class GlobalExceptionHandler {
    ...
    // 🔐 Handle validation errors from @Valid DTOs (like RegisterRequest, AuthRequest)
    ...
    // ⚠️ Duplicate key (e.g. same email during registration)
    ...
    // ⚠️ Type mismatch in query params (e.g., wrong type for @RequestParam)
    ...
    // ⚠️ Any runtime exceptions (fallback)
